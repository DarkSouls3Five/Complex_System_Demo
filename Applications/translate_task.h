...
#define TRANS_MOVE_ANGLE 500.0f//ÒÆ¶¯¶þ·ÖÖ®Ò»±ß³¤
#define TRANS_MOVE_ANGLE_HALF 250.0f//ÒÆ¶¯ËÄ·ÖÖ®Ò»±ß³¤
#define TRANS_DISTANCE_ERR 20.0f//Î»ÒÆÆ«²î
...
typedef enum
{
  TRANS_FREE,
	TRANS_LOCK,
	TRANS_MOVE_L,//µ¥µç»ú×óÒÆ
	TRANS_MOVE_R,//µ¥µç»úÓÒÒÆ
